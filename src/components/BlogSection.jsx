        ...
        <div className="bg-gray-900 p-5">
            <section className="mt-12 mx-auto px-4 max-w-screen-xl md:px-8">
                <div className="text-center">
                    ...
                    Explore helpful tips, insights, and stories from my journey as a front-end developer — all in one place
                    </p>
                </div>
                <div className="mt-12 grid gap-2 sm:grid-cols-2 lg:grid-cols-3">
                    {
                        posts.map((items, key) => (
                            <article className="bg-gray-900 max-w-md mx-auto mt-4 shadow-lg border border-[#ac6ccf] rounded-md duration-300 hover:scale-108" key={key}>
                                <a href={items.href}>
                                    ...
                                    <div className="flex items-center mt-2 pt-3 ml-4 mr-2">
                                        ...
                                        <div className="ml-3">
                                            <span className="block text-gray-400">{items.authorName}</span>
