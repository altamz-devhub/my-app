    ...
    const Brand = () => (
        <div className="flex items-center justify-between py-5 md:block">
            ...
            <div className="md:hidden">
                <button className="menu-btn text-gray-400 hover:text-gray-300 cursor-pointer"
                    ...
                    <div className="gap-x-14 items-center max-w-screen-xl mx-auto px-4 md:flex md:px-8">
                        ...
                        <div className={`flex-1 items-center mt-8 md:mt-0 md:flex ${state ? 'block' : 'hidden'} `}>
                            <ul className="flex-1 justify-end items-center space-y-6 md:flex md:space-x-6 md:space-y-0">
                                ...
                                <li>
                                    <a href="javascript:void(0)" className="flex items-center justify-center gap-x-1 py-2 px-4 text-white font-medium bg-gradient-to-r from-pink-500 to-blue-500 hover:scale-105 active:bg-sky-600 duration-150 rounded-full md:inline-flex">
                                        Hire Me
                ...
                <div className="relative z-10 max-w-screen-xl mx-auto px-4 py-28 md:px-8">
                    ...
                    <h2 className="text-3xl font-bold bg-gradient-to-r from-pink-500 to-blue-500 bg-clip-text text-transparent">
                        ...
                        <p className="max-w-2xl mx-auto text-gray-400">
                            I transform static designs into engaging, dynamic web experiences.
                        </p>
                        <form
                            onSubmit={(e) => e.preventDefault()}
                            className="justify-center items-center gap-x-3 sm:flex">
                            <button className="cursor-pointer flex items-center justify-center gap-x-2 py-2.5 px-4 mt-3 w-full text-sm text-white font-medium bg-gradient-to-r from-pink-500 to-blue-500 hover:scale-105 active:bg-sky-600 duration-150 rounded-lg sm:mt-0 sm:w-auto">
                                Download CV
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5">
